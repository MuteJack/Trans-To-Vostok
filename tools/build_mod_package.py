...
# Hand-edited source files (live under <repo>/src/).
SRC_FILES = ["translator_ui.gd", "translator.gd", "texture_loader.gd", "mod_addon.gd", "locale.json"]
# Build-output files (live under <repo>/Trans To Vostok/, generated by build_mod_info.py).
...
def package_mod(mod_root: Path, locales: list[str], out_path: Path) -> tuple[int, int]:
    ...
    try:
        with zipfile.ZipFile(tmp_path, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            # 2a. Hand-edited source files (<repo>/src/) → Trans To Vostok/
            ...
            # 2b. Build-output files (pkg_root) → Trans To Vostok/
...
def load_locale_config(mod_root: Path) -> list[dict]:
    ...
    locale_json = mod_root / "src" / "locale.json"
