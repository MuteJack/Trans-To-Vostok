...
Differs from Translation:
  - THICK_RIGHT_HEADERS: Class / untranslatable / translation
    (KIND and unique_id don't exist in Glossary).
  - Group separator columns: Category (thick) / Sub-Category (thin).
  - Duplicate detection on text / translation only (no unique_id).
  - 'method' column doesn't exist -> that CF block silently no-ops.

Usage:
    python tools/utils/rebuild_glossary_xlsx.py <locale>
"""
...
CATEGORY = "Glossary"
THICK_RIGHT_HEADERS = {"Class", "untranslatable", "translation"}
WRAP_TEXT_HEADERS = {"text", "translation", "description"}
GROUP_THICK_HEADER = "Category"
GROUP_THIN_HEADER = "Sub-Category"
DUP_CHECK_HEADERS = ["text", "translation"]
